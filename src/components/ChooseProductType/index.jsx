...
import styles from "./ChooseProductType.module.scss";
    ...
    <div className={cx("container")}>
      <div className={cx("header")}>
        ...
        <p className={cx("subtitle")}>
          Chọn định dạng phù hợp nhất với những gì bạn đang bán - hướng dẫn,
          khóa học, coaching, hoặc nhiều hơn nữa!
        </p>
      </div>
      ...
      <div className={cx("product-grid")}>
        {productTypes.map((product) => (
          ...
          >
            {renderIcon(product.icon, product.bgColor)}
